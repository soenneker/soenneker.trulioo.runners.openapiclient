...
using Soenneker.Trulioo.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Trulioo.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Trulioo:ClientGenerationUrl"] ?? "https://docs.verification.trulioo.com/redocusaurus/CustomerAPIv2_5.yaml";
        ...
        await _kiotaUtil.Generate(fixedFilePath, "TruliooOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
    ...
    private async ValueTask BuildAndPush(string gitDirectory, CancellationToken cancellationToken)
    {
        ...
        if (!successful)
            throw new InvalidOperationException("The generated Trulioo OpenAPI client did not build successfully.");
